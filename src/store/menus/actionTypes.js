...
/* MENU DETAILS */
export const GET_MENUS_DETAIL = "GET_MENUS_DETAIL";
export const GET_MENUS_DETAIL_SUCCESS = "GET_MENUS_DETAIL_SUCCESS";
export const GET_MENUS_DETAIL_FAIL = "GET_MENUS_DETAIL_FAIL";

export const GET_MENU_COMMENTS = "GET_MENU_COMMENTS";
export const GET_MENU_COMMENTS_SUCCESS = "GET_MENU_COMMENTS_SUCCESS";
export const GET_MENU_COMMENTS_FAIL = "GET_MENU_COMMENTS_FAIL";
